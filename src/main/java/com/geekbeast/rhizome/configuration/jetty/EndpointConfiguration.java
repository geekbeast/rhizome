...
public class EndpointConfiguration {
    ...
    public EndpointConfiguration( 
            @JsonProperty( value = HTTP_PORT_PROPERTY , required = true ) Optional<Integer> httpPort,
            @JsonProperty( value = HTTPS_PORT_PROPERTY , required = true ) Optional<Integer> httpsPort,
