...
/**
 * Temporarily borrowed from here: https://github.com/jsevellec/cassandra-unit
 * Very mysterious bug related to start call-- only works with no arg method.
...
public class EmbeddedCassandraServerHelper {
    ...
    private static void dropKeyspacesWithNativeDriver() {
        ...
        try ( com.datastax.driver.core.Cluster cluster = com.datastax.driver.core.Cluster.builder()
                .addContactPoint( host ).withPort( port ).build();
